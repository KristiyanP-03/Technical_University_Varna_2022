    ...
    case WM_COMMAND:
        {
            ...
            case IDM_OPTION:
                ...
                break;
            case IDM_ACTION:
                MessageBox(hWnd, L"Action Item is selected", L"Info", MB_OK);
                break;
            case IDM_ACTIVATE_OPT:
                MessageBox(hWnd, L"ACTIVATE Item is selected", L"Info", MB_OK);
                break;
            case IDM_DISABLE_ACT:
                MessageBox(hWnd, L"DISABLE Item is selected", L"Info", MB_OK);
                break;
            case IDM_ABOUT:
