...
INT_PTR CALLBACK    MyOwnFunctionForMyFirstDialog(HWND, UINT, WPARAM, LPARAM);
...
INT_PTR CALLBACK MyOwnFunctionForMyFirstDialog(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    UNREFERENCED_PARAMETER(lParam);
    switch (message)
    {
